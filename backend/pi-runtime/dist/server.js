...
import { getModel, registerApiProvider, Type } from "@mariozechner/pi-ai";
...
async function handleRequest(req) {
    ...
    try {
        ...
        const modelInstance = getModel(llmProvider, llmModel);
